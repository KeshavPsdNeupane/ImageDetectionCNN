...
public:
	...
	void WriteWeight(const std::string& filePath, const std::vector<std::vector<float>>& weight);
	void WriteBias(const std::string& filePath ,const std::vector<float>& bias);
